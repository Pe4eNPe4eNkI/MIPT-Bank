...
public class home_fragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        ImageButton throw_away = (ImageButton) getView().findViewById(R.id.throw_away);

        withdraw.setEnabled(false);
        replenishment.setEnabled(false);
        throw_away.setEnabled(false);
        ...
        if (constants.entered == 1) {
            ...
            replenishment.setVisibility(View.INVISIBLE);
            throw_away.setVisibility(View.INVISIBLE);
        ...
        throw_away.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.throwAway);
            }
        });
        ...
        debit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (constants.entered == 1 && constants.have_debit == 0) {
                    ...
                    replenishment.setVisibility(View.VISIBLE);
                    throw_away.setVisibility(View.VISIBLE);
                    withdraw.setEnabled(true);
                    replenishment.setEnabled(true);
                    throw_away.setEnabled(true);
        ...
        credit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                } else if (constants.entered == 1 && constants.have_debit == 1 && constants.selected_key != 2) {
        ...
        deposit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                } else if (constants.entered == 1 && constants.have_debit == 1 && constants.selected_key != 3) {
