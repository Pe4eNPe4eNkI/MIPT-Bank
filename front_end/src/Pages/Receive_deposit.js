...
class ReceiveDeposit extends Component {
    constructor(props) {
        super(props);
                ...
                <div className="Receiving">
                    ...
                    <div className = "Card_block">
                        <div className="card">
                            ...
                            <text className = "type_card" width="auto" height="auto">Debit</text>
                        ...
                        <text className = "characteristics_card_2" width="auto" height="auto">Upt to 7.5% per annum</text>
                        <text className = "characteristics_card_3" width="auto" height="auto">Government-free system</text>
                        <text className = "characteristics_card_4" width="auto" height="auto">Use deposit like a card</text>
